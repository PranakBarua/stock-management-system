<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanySetupUI.aspx.cs" Inherits="StockManagementSystem.UI.CompanySetup" %>
...
<body>
    <form id="companyForm" runat="server">
        ...
        <asp:GridView ID="companyGridView"  class="display" style="width:100%" runat="server" AutoGenerateColumns="False">
            <Columns>
    ...
    <script>
        $(function () {
            ...
            $("#companyForm").validate({
                ...
                messages: {
                    nameTextBox: "Please enter a company name"
                }
            });
